...
ActiveRecord::Schema[8.1].define(version: 2026_08_23_175131) do
  ...
  create_table "rates", force: :cascade do |t|
    ...
    t.index ["currency", "on_date", "provider"], name: "index_rates_on_currency_and_on_date_and_provider", unique: true
  end
end
